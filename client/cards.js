...
const boosts = [
	...
	new Boost('Kill the Hireling', 'KillTheHireling.jpeg', (player) => player.game.hireling),
	new Boost('Potion of General Studliness', 'PotionOfGeneralStudliness.jpeg'),
	new Boost('Whine at the GM', 'WhineAtGM.jpeg', (player) =>
		player.game.playerOrder.some((otherPlayer) => otherPlayer.level > player.level)
	)
	// ,
	// new Boost('Mutilate the Bodies', 'MutilateTheBodies.jpeg', (player) => player.didKillMonster)
];
